...
- [chinese-markdown-style](skills/chinese-markdown-style/SKILL.md) — the Chinese-doc style rules I follow, plus how to run `cn-doc-style-guide/tools/` to enforce them.
